...
//      validateMessagesAndAssignOffsetsCompressed(records, topicPartition, offsetCounter, time, now, sourceCodec, targetCodec, compactedTopic,
    validateMessagesAndAssignOffsetsCompressed(records, topicPartition, offsetCounter, time, now, sourceType, targetConfig, compactedTopic,
...
//=======
      ...
      buildRecordsAndAssignOffsets(toMagic, offsetCounter, time, timestampType, targetConfig.getType,
