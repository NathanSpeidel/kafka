...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(ProducerConfig config,
        ...
        try {
            ...
            this.compressionLevel = config.getInt(ProducerConfig.COMPRESSION_LEVEL_CONFIG);
            log.info("Using compression level: " + compressionLevel);
            ...
            this.accumulator = new RecordAccumulator(logContext,
                    ...
                    CompressionConfig.of(this.compressionType, this.compressionLevel),
                    lingerMs(config),
                    retryBackoffMs,
                    deliveryTimeoutMs,
                    metrics,
